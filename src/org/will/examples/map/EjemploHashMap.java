...
public class EjemploHashMap {
    public static void main(String[] args) {
        ...
        String apellido= (String) persona.get("nombre");
        ...
        boolean b = persona.remove("apellidoPaterno","Does");
        ...
        boolean b3 = persona.containsValue("john.doe@email.co");
        ...
        System.out.println("contiene elementos "+!persona.isEmpty());
        boolean b4 = persona.replace("nombre","John","Andres");
